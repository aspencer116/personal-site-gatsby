      ...
      <section className="c-case-study-header">
        ...
        <CSSTransition
          ...
          <div className="c-case-study-header__secondary">
              <Parallax speed={-2}>
                <Img fluid={data.HBRheader.childImageSharp.fluid} class="c-case-study-header__image" alt="Person holding a phone in their lap looking at the Harvard Business Review mobile app."/>
              </Parallax>
          </div>
        </CSSTransition>
      </section>
