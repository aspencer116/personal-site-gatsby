        ...
        >
          <div className="c-homepage-hero__text-container">
            ...
            <div className="o-relative c-homepage-hero__detail-container">
              <svg className="c-homepage-hero__icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><g clip-path="url(#a)"><path stroke="#0B0C0C" stroke-width="1.5" d="M12.344 2.738h6.906v9.5H6.39v-9.5h5.954Z"/><path stroke="#0B0C0C" stroke-width="1.5" d="m19.648 12.271-4.74 4.741H2.066l4.846-4.893"/><path fill="#0B0C0C" d="M13.014 5.013h4v4h-4z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h20v20H0z"/></clipPath></defs></svg>
            ...
            <div className="o-relative c-homepage-hero__detail-container">
              <svg className="c-homepage-hero__icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path stroke="#0B0C0C" stroke-width="1.5" d="M10 3.75h9.25v13.5H.75V12"/><path fill="#0B0C0C" d="m1.582 9.997 4-7.966 4 7.966h-8ZM4.582 9.997h2v2h-2z"/></svg>
              <span className="t-meta t-meta--small c-homepage-hero__detail">New Englander</span>
            </div>
            <div className="o-relative c-homepage-hero__detail-container">
              <svg className="c-homepage-hero__icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path stroke="#0B0C0C" stroke-width="1.5" d="M1.276 10.02h17.448M10.059 0v20"/><path stroke="#0B0C0C" stroke-width="1.6" d="m3.504 3.458 13.077 13.077M3.381 16.469 16.458 3.392"/><rect width="5.898" height="5.898" x="7.051" y="7.051" fill="#0B0C0C" rx="2.949"/></svg>
