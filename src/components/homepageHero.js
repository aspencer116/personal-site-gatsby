...
const HomepageHero = () => {
  ...
  return (
    <section className="homepage-hero">
      <div className="homepage-hero__primary">
        <div className="homepage-hero__text-column">
          <h1 className="t-heading-1 t-heading-1--reverse homepage-hero__heading">Web Designer & <br/>Developer</h1>

          <div className="homepage-hero__text-container">
      ...
      <div className="homepage-hero__secondary">
        <p className="t-meta homepage-hero__meta-text">Design&nbsp;&&nbsp;Code</p>

        <div className="homepage-hero__background-image">
          <Img fluid={data.heroBackground.childImageSharp.fluid} alt="Green woods with a mysterious look"/>
        </div>
      </div>
      <div className="homepage-hero__tertiary">
      </div>
    </section>
  )
}
