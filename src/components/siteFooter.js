...
const SiteHeader = () => (
  <footer className="c-site-footer">
    ...
    <div className="c-site-footer__secondary">
      <ul className="c-site-footer__social-list">
        <li className="c-site-footer__social-list-item">
          <a className="c-site-footer__social-link" href="https://dribbble.com/iam_aspencer" target="_blank">
        ...
        <li className="c-site-footer__social-list-item">
          <a className="c-site-footer__social-link" href="https://codepen.io/iam_aspencer/" target="_blank">
        ...
        <li className="c-site-footer__social-list-item">
          <a className="c-site-footer__social-link" href="https://github.com/aspencer116" target="_blank">
            <svg className="c-site-footer__social-link--icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60">
        ...
        <li className="c-site-footer__social-list-item">
          <a className="c-site-footer__social-link" href="https://www.instagram.com/iam_aspencer/" target="_blank">
        ...
        <li className="c-site-footer__social-list-item">
          <a className="c-site-footer__social-link" href="https://unsplash.com/@iam_aspencer" target="_blank">
    ...
    <div className="c-site-footer__tertiary">
      ...
      <span className="c-site-footer__meta">
        Built with <a className="c-site-footer__meta-link" href="https://www.gatsbyjs.org" target="_blank">Gatsby</a>. See the <Link className="c-site-footer__meta-link" to="/pattern-library/">pattern library</Link> and <a className="c-site-footer__meta-link" href="https://github.com/aspencer116/personal-site-gatsby" target="_blank" >GitHub repo</a>.
      </span>
    </div>
  </footer>
)
