...
const CaseStudyHeaderShoesForCrews = ({ title, subtitle, tags, year, image, imageAltText }) => {
  const data = useStaticQuery(graphql`
    query {
      headerImage: file(relativePath: { eq: "shoes-for-crews/feature-image-3.jpg" }) {
    ...
    <div className="c-case-study-header">
      ...
      >
        <div className="c-case-study-header__secondary">
            <Parallax speed={-2}>
              <Img fluid={data.headerImage.childImageSharp.fluid} alt={imageAltText} class="c-case-study-header__image"/>
            </Parallax>
        </div>
      </CSSTransition>
    </div>
...
export default CaseStudyHeaderShoesForCrews
