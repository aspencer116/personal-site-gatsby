...
const CaseStudyHeaderPicSnippets = ({ title, subtitle, tags, year, image, imageAltText }) => {
  const data = useStaticQuery(graphql`
    query {
      headerImage: file(relativePath: { eq: "picsnippets/feature-image.jpg" }) {
        childImageSharp {
...
export default CaseStudyHeaderPicSnippets
